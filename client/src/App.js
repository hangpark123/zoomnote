...
function App() {
  ...
  const handleClearTemplate = async () => {
    ...
    try {
      ...
      // alert(data.message || '고정값이 해제되었습니다.'); // 너무 빈번한 alert 제거

      // 상태만 업데이트 (화면 내용은 지우지 않음!)
      setUserTemplate(null);
      setHasTemplate(false);
      // setTitle(''); <--- 삭제: 작성 중인 내용 유지
      // setPeriodStart(null); <--- 삭제
      // setPeriodEnd(null); <--- 삭제
    } catch (e) {
      console.error('고정값 해제 실패:', e);
            ...
            <div className="print-preview-area">
              ...
              <div className="print-top-row">
                <div className="print-meta-grid">
                  ...
                  <div style={{ gridColumn: '2 / -1' }}>{previewNote.title || '-'}</div>
                </div>
              ...
              <div className="print-weekly-goal-section" style={{ marginBottom: 24 }}>
